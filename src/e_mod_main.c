...
static void
_e_text_input_method_context_cb_hide_ime(struct wl_client *client EINA_UNUSED, struct wl_resource *resource, uint32_t serial)
{
...
static const struct wl_input_method_context_interface _e_text_input_method_context_implementation = {
     ...
     _e_text_input_method_context_cb_hide_ime
};
